...
urlpatterns = [
    ...
    path('goal_comment/list', views.GoalCommentListView.as_view(), name='goal_comments_list'),
    path('goal_comment/<int:pk>', views.GoalCommentView.as_view(), name='goal_comment'),
]
